...
__SEC_ROH specification const _specification = {
  "PHIDSPEC", 0x10016000, 0xf4000e000, 0x10023000, 8, _specification_cpus, _specification_irq_owners, &_specification_arch, "2017/07/02 15:27:22"
};
__SEC_RO const vm * const _specification_irq_owners[IRQID_MAXIMUM] = {
};
__SEC_RO specification_arch const _specification_arch = {};
...
__SEC_RO memarea const cpu0_memareas[34] = {
  ...
  { 0, 0, 0, 0, NULL },
  { 0x100be000, 0xf50200000, 0x119c000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
