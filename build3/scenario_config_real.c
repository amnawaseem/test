...
__SEC_RO memarea const vm_linux1_cpu0_memareas[2];
...
__SEC_ROH specification const _specification = {
  "PHIDSPEC", 0x10016000, 0xf4000e000, 0x10023000, 8, _specification_cpus, _specification_irq_owners, &_specification_arch, "2017/06/28 15:45:05"
};
__SEC_RO const vm * const _specification_irq_owners[IRQID_MAXIMUM] = {
};
__SEC_RO specification_arch const _specification_arch = {};
__SEC_RO specification_cpu const _specification_cpus[8] = {
  { 0x10031000, 34, cpu0_memareas, &cpu0_memtree, 1, cpu0_vm_cpus, {} },
  { 0x1003f000, 32, cpu1_memareas, &cpu1_memtree, 0, NULL, {} },
  { 0x1004d000, 32, cpu2_memareas, &cpu2_memtree, 0, NULL, {} },
  { 0x1005b000, 32, cpu3_memareas, &cpu3_memtree, 0, NULL, {} },
  { 0x10069000, 32, cpu4_memareas, &cpu4_memtree, 0, NULL, {} },
  { 0x10077000, 32, cpu5_memareas, &cpu5_memtree, 0, NULL, {} },
  { 0x10085000, 32, cpu6_memareas, &cpu6_memtree, 0, NULL, {} },
  { 0x10093000, 32, cpu7_memareas, &cpu7_memtree, 0, NULL, {} },
};
__SEC_RO memarea const cpu0_memareas[34] = {
  ...
  { 0, 0, 0, 0, NULL },
  { 0x100be000, 0xf50200000, 0x11ad000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
...
__SEC_RW vm_cpu vm_linux1_cpus[1] = {
  { &vm_linux1, (vm_cpu_state *)0xf400c8000, 0,
    0x10094000, 1,
    2, vm_linux1_cpu0_memareas, &vm_linux1_cpu0_memtree,
...
__SEC_RO vm_copyin const vm_linux1_copyins[3] = {
  { 0x40080000, 0xf50200000, 0x862008 },
  { 0x4a000000, 0xf50a62008, 0x94288d },
  { 0x40008000, 0xf513a4895, 0x7ce3 },
};
__SEC_RO capability const vm_linux1_capabilities[0] = {
};
__SEC_RW scheduler_entity vm_linux1_cpu0_scheds[1] = {
...
__SEC_RO tree_memarea const vm_linux1_cpu0_memtree = { &vm_linux1_cpu0_memtree_l, NULL, vm_linux1_cpu0_memareas + 1 };
__SEC_RO emulate const vm_linux1_cpu0_emulates[13] = {
