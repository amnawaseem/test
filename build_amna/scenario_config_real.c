...
__SEC_ROH specification const _specification = {
  "PHIDSPEC", 0x10016000, 0xf4000e000, 0x10022000, 2, _specification_cpus, _specification_irq_owners, &_specification_arch, "2017/07/25 16:57:16"
};
__SEC_RO const vm * const _specification_irq_owners[IRQID_MAXIMUM] = {
};
__SEC_RO specification_arch const _specification_arch = {};
__SEC_RO specification_cpu const _specification_cpus[2] = {
  { 0x10037000, 40, cpu0_memareas, &cpu0_memtree, 2, cpu0_vm_cpus, {} },
  { 0x1004a000, 36, cpu1_memareas, &cpu1_memtree, 0, NULL, {} },
};
__SEC_RO memarea const cpu0_memareas[40] = {
  ...
  { 0, 0, 0, 0, NULL },
  { 0x1006d000, 0xf50200000, 0x1a3a000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
...
__SEC_RW vm_cpu vm_linux2_cpus[1] = {
  { &vm_linux2, (vm_cpu_state *)0xf400f0000, 0,
    0x1004c000, 1,
...
__SEC_RO vm_copyin const vm_linux2_copyins[3] = {
  { 0x280000, 0xf50a92808, 0x892808 },
  { 0xa200000, 0xf51325010, 0x90cb79 },
  { 0x208000, 0xf51c31b89, 0x7df7 },
};
__SEC_RO capability const vm_linux2_capabilities[1] = {
...
__SEC_RO memarea const vm_linux2_cpu0_memareas[6] = {
  { 0x11c00000, 0x0, 0x30000000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_X, cpu0_memareas + 36 },
  { 0xc0000, 0xfee00000, 0x20000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_S, cpu0_memareas + 32 },
  { 0xe4000, 0xfee20000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_S, cpu0_memareas + 33 },
  { 0xe0000, 0xfee21000, 0x2000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_S, cpu0_memareas + 34 },
  { 0xe2000, 0xfee23000, 0x2000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_S, cpu0_memareas + 35 },
...
__SEC_RW vm_cpu vm_linux1_cpus[1] = {
  { &vm_linux1, (vm_cpu_state *)0xf400f2000, 0,
    0x10052000, 2,
...
__SEC_RO vm_copyin const vm_linux1_copyins[3] = {
  ...
  { 0x3a400000, 0xf51325010, 0x90cb79 },
  { 0x30408000, 0xf51c31b89, 0x7df7 },
};
__SEC_RO capability const vm_linux1_capabilities[1] = {
...
__SEC_RO memarea const vm_linux1_cpu0_memareas[7] = {
  { 0x41c00000, 0x0, 0x30000000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_X, cpu0_memareas + 38 },
